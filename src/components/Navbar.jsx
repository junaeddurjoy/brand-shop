    ...
    return (
        <div>
            <div className="navbar bg-base-300">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 justify-center items-center lg:gap-5 mx-3 text-md font-bold">
                    <Link to={'/'}>
                        <div className="hover:bg-gray-300 lg:p-3 rounded-full">
                            Home
                        </div>
                    </Link>
                    <Link to={'/addProduct'}>
